...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-[3px]",
  {
    variants: {
      variant: {
        default:
          "bg-[#64A5E3] text-white shadow-xs hover:bg-[#3D85C6] focus-visible:ring-[#1F4E79]/50",
        destructive:
          "bg-red-500 text-white shadow-xs hover:bg-red-600 focus-visible:ring-red-500/50",
        outline:
          "border border-[#1F4E79] text-[#1F4E79] shadow-xs hover:bg-[#64A5E3]/20",
        secondary:
          "bg-[#3D85C6] text-white shadow-xs hover:bg-[#1F4E79]",
        ghost:
          "hover:bg-[#64A5E3]/20 text-[#1F4E79] dark:hover:bg-[#3D85C6]/30",
