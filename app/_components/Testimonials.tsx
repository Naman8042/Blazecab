    ...
    <section className="py-10">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-[#1565C0] mt-2">
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-300 shadow-lg text-center">
                  ...
                  <div className="mt-4 flex flex-col items-center">
                    <Image
                      ...
                      className="rounded-full border border-[#1565C0]"
                    />
                    <h3 className="font-semibold text-[#1565C0] mt-2 text-sm">
                      {testimonial.name}
                    </h3>
