...
const RouteInfoSection = ({ distance, time, startingFare }: RouteInfoProps) => {
      ...
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="mb-10 text-center md:mb-14">
          ...
          <p className="text-sm font-normal text-gray-500 max-w-xl mx-auto md:text-lg">
            Here are the key details for your upcoming trip, including
            distance, estimated time, and starting fare.
          </p>
        </div>
  ...
  <div className="flex flex-col items-center">
    ...
    <h3 className="text-sm md:text-2xl font-bold text-gray-900">{distance}</h3>
  </div>
  ...
  <div className="flex flex-col items-center">
    ...
    <h3 className="text-sm md:text-2xl font-bold text-gray-900">{time}</h3>
  </div>
